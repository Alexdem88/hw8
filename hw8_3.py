...
# Проверить работу исключения на реальном примере. Запрашивать
# у пользователя данные и заполнять список необходимо только числами.
...
class Error:
    ...
    def my_input(self):
        ...
        while True:
            try:
                val = int(input('Введите цифры и нажимайте Enter - '))
